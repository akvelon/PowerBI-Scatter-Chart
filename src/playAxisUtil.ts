...
import { valueFormatter, interfaces, textMeasurementService } from "powerbi-visuals-utils-formattingutils";
import { ITooltipServiceWrapper } from "powerbi-visuals-utils-tooltiputils";
import { IAxes, ISize, PlayAxisUpdateData, VisualDataPoint } from "./visualInterfaces";
...
export class PlayAxis {
    ...
    constructor(mainElement: HTMLElement, mainSvgElement: d3.Selection<SVGElement>, tooltipServiceWrapper: ITooltipServiceWrapper) {
